...
struct Settings {
    ...
    bool  offlineBakeUseCurrentState = false;
    bool  offlineBakeInjectSource = true;
    ...
    int   offlineBakeWorkspace = kWorkspaceSmoke3D;
    int   offlineBakeWarmupSteps = 24;
    int   offlineBakeSourceDurationFrames = 240;
    float offlineBakeFixedDt = 1.0f / 120.0f;
    float offlineBakeSourcePosX = 0.50f;
    float offlineBakeSourcePosY = 0.12f;
    float offlineBakeSourcePosZ = 0.50f;
    float offlineBakeSourceRadius = 0.14f;
    float offlineBakeSmokeAmount = 0.60f;
    float offlineBakeHeatAmount = 1.20f;
    float offlineBakeWaterAmount = 0.20f;
    float offlineBakeSourceVelX = 0.0f;
    float offlineBakeSourceVelY = 3.0f;
    float offlineBakeSourceVelZ = 0.0f;
